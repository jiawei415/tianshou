...
do
    ...
    python -m tianshou.scripts.run_${alg_type}_atari --seed ${seed} --task ${task} --size ${size} \
    ...
    --ensemble-num=${ensemble_num} --ensemble-layer=${ensemble_layer} --ensemble-size=${ensemble_size} \

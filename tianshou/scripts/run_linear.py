...
from tianshou.utils.net.common import LinearNet, trunc_normal_init, xavier_normal_init, xavier_uniform_init
from tianshou.utils.net.discrete import NewLinear
